...
if __name__ == '__main__':
    ...
    src_net_path = 'experiments/pretrained_models/RRDB_ESRGAN_x4.pth'
    save_net_path = 'experiments/pretrained_models/RRDB_ESRGAN_x4.pth'

    convert_esrgan_model(src_net_path, save_net_path)
